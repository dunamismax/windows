...
icacls "D:\opal\" /grant "NETWORK SERVICE":(OI)(CI)F /T
icacls "D:\opal\" /grant "LOCAL SERVICE":(OI)(CI)F /T
icacls "D:\opal\" /grant "Everyone":(OI)(CI)F /T
icacls "D:\opal\" /grant "Authenticated Users":(OI)(CI)F /T
icacls "D:\opal\" /grant "Users":(OI)(CI)F /T
icacls "D:\opal\" /grant "Administrators":(OI)(CI)F /T
takeown /f D:\opal\ /r /d y
